...
/**
 * @deprecated These tests are for the old step-based GenerateWizard component.
 * The page now uses CampaignEditor which is an accordion-based wizard.
 * See page.test.tsx for the current tests.
 */
describe.skip("GenerateWizard", () => {
  beforeEach(() => {
    mockFetch.mockReset();
    setupMockFetch();
  });
  ...
  describe("Initial Render", () => {
    ...
    it("shows step indicator with all 8 steps", async () => {
      ...
      expect(screen.getAllByText("Preview & Create").length).toBeGreaterThanOrEqual(1);
    });
