...
describe("HierarchyConfig", () => {
  ...
  // Note: These tests expect a hierarchy-preview element that was removed.
  // The preview is now handled by HierarchyPreview component in the parent.
  // ==========================================================================

  describe.skip("Hierarchy Preview (Real-time)", () => {
  ...
  describe("Edge Cases", () => {
    ...
    // Note: These tests expect UI elements that were moved to HierarchyPreview component
    it.skip("handles empty sample data array", () => {
      render(
        <HierarchyConfig
          config={createDefaultHierarchyConfig()}
          campaignConfig={defaultCampaignConfig}
    ...
    it.skip("handles missing columns in sample data gracefully", () => {
      const config: HierarchyConfigType = {
        adGroups: [{
          id: "ag-1",
