...
export function GenerateWizard() {
  ...
  const { currentStep, dataSourceId, campaignConfig, hierarchyConfig, availableColumns, campaignSetName, campaignSetDescription } = state;
      ...
      case "ad-type":
        return (
          <div className={styles.stepContent} data-testid="step-content">
            <h2 className={styles.stepTitle}>{STEP_LABELS[currentStep]}</h2>
            <p className={styles.stepDescription}>
              Select the ad types you want to include in your campaign set.
            </p>
            <AdTypeSelector
      ...
      case "rules":
        return (
          <div className={styles.stepContent} data-testid="step-content">
            <h2 className={styles.stepTitle}>{STEP_LABELS[currentStep]}</h2>
            <p className={styles.stepDescription}>
              Create rules to filter or modify data before creating your campaign set.
            </p>
            <InlineRuleBuilder
      ...
      case "platform":
        return (
          <div className={styles.stepContent} data-testid="step-content">
            <h2 className={styles.stepTitle}>{STEP_LABELS[currentStep]}</h2>
            <p className={styles.stepDescription}>
              Select one or more platforms for your campaign set.
            </p>
            <PlatformSelector
              selectedPlatforms={state.selectedPlatforms}
      ...
      case "preview":
        return (
          <div className={styles.stepContent} data-testid="step-content">
            <h2 className={styles.stepTitle}>{STEP_LABELS[currentStep]}</h2>
            <p className={styles.stepDescription}>
              Review your campaign set before creating it.
            </p>
        ...
        <div className={styles.restoreDialog} role="dialog" aria-labelledby="restore-dialog-title">
          <div className={styles.restoreDialogContent}>
            ...
            <p className={styles.restoreDialogText}>
              You have an unfinished campaign set. Would you like to continue where you left off?
            </p>
        ...
        <div className={styles.headerRight}>
          ...
          {showGenerateInHeader && (
            <button
              ...
              aria-label={isReadyToGenerate ? "Continue to preview" : "Complete all steps to create"}
            >
          ...
          {showStartOver && (
            <div className={styles.navigation} role="navigation" aria-label="Wizard navigation">
              <button
                ...
                onClick={reset}
                className={`${styles.button} ${styles.buttonSecondary}`}
                aria-label="Start a new campaign set"
              >
                Create Another Set
              </button>
            </div>
